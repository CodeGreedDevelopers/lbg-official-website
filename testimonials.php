...
<head>
    ...
    <meta name="description" content="Testimony proof evidence from subscribed paid members in VIP telegram matches.">
    ...
    <title>LiveBettingGoal - Subscribe</title>
    ...
    <div class="over-wrap">
                ...
                <nav style="margin: 0px;" class="tm-navbar uk-navbar" data-uk-sticky="">
                    <div class="uk-container uk-container-center">
                        ...
                        <ul class="uk-navbar-nav uk-hidden-small">
                            ...
                            <li class="uk-active" data-uk-dropdown="{'preventflip':'y'}" aria-haspopup="true" aria-expanded="false"><a href="testimonials.php">Testimonials</a></li>
        ...
        <div class="uk-container uk-container-center alt">
            <ul class="uk-breadcrumb">
                ...
                <li><a href="faq.php">Testimonials</a>
                </li>
            </ul>
        </div>
                        ...
                        <div class="uk-panel our-awards-wrap">
                            <div class="uk-width-1-1">
                                <div class="our-awards-title">
                                    <h3>What some of my <a href="subscribe.php"><span >VIP clients </span></a> have to says about the service offered</h3>
                                </div>
                            </div>
                            <div dir="ltr" class="uk-slidenav-position our-awards" data-uk-slider="{default: 6, autoplay:true, autoplayInterval:7000, animation: 'slide-bottom', duration: 400}">
                                <div class="uk-slider-container">
                                    <ul class="uk-slider uk-grid uk-grid-width-large-1-3 uk-grid-width-medium-1-2">
                                        <li class="uk-slide-after">
                                            <div class="img-wrap" ><img draggable="false" src="images/testimonials/testimony 1_compressed.jpg" alt="">
                                            </div>
                                            
                                        </li>
                                        <li class="uk-slide-after">
                                            <div class="img-wrap" ><img draggable="false" src="images/testimonials/testimony 2_compressed.jpg" alt="">
                                            </div>
                                            
                                        </li>
                                        <li class="uk-slide-after">
                                            <div class="img-wrap" ><img draggable="false" src="images/testimonials/testimony 3_compressed.jpg" alt="">
                                            </div>
                                            
                                        </li>
                                        <li class="uk-slide-after">
                                            <div class="img-wrap" ><img draggable="false" src="images/testimonials/testimony 5_compressed.jpg" alt="">
                                            </div>
                                            
                                        </li>
                                        <li class="uk-slide-after">
                                            <div class="img-wrap" ><img draggable="false" src="images/testimonials/testimony 6_compressed.jpg" alt="">
                                            </div>
            ...
            <div id="offcanvas" class="uk-offcanvas">
                    <div class="uk-offcanvas-bar">
                        <ul class="uk-nav uk-nav-offcanvas">
                            ...
                            <li class="uk-active"><a href="testimonials.php">Testimonials</a></li>
